        ...
        @if (Auth::user()->hasPermission('view_receipts'))
            <li class="-mb-px mr-1">
                <a href="{{ route('admin.currencies.index') }}"
                    class="inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold {{ request()->routeIs('admin.currencies.index') ? 'border-l border-t border-r rounded-t text-blue-700 bg-gray-100' : '' }}">
                    Валюты
                </a>
            </li>
        @endif
