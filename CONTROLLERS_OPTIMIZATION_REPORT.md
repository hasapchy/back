...
1. **OrderController**
   - ✅ Вынесена логика проверки категорий для basement workers в метод `resolveCategoryForBasementWorker()` (строки 76-113, 198-235)
...
**Проблемы:**
1. **Строка 78-113, 199-235**: Дублирование логики проверки категорий для basement workers - можно вынести в метод
