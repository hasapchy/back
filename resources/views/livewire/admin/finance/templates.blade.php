...
<div class="mx-auto p-4">
    ...
    <div id="templateModalBackground"
        ...
        <div id="templateForm"
            class="fixed top-0 overflow-y-auto right-0 w-1/3 h-full bg-white shadow-lg transform transition-transform duration-500 ease-in-out z-50 mx-auto p-4"
            ...
            <form>
                ...
                <div class="mt-4 flex justify-start space-x-2">
                    <button wire:click="saveTemplate" class="bg-[#5CB85C] text-white px-4 py-2 rounded">
    ...
    <div id="applyTemplateModalBackground"
        ...
        <div id="applyTemplateForm"
            ...
            <div class="mt-4 flex justify-start space-x-2">
                <button wire:click="saveAppliedTemplate" class="bg-[#5CB85C] text-white px-4 py-2 rounded">
                    <i class="fas fa-save"></i>
                </button>
            </div>
        </div>
