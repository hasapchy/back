...
class UserCompanyController extends BaseController
{
    ...
    public function getUserCompanies()
    {
        ...
        $query = $user->companies()->select(
            ...
            'companies.rounding_orders_decimals',
            'companies.rounding_contracts_enabled',
            'companies.rounding_contracts_decimals',
            'companies.rounding_warehouse_enabled',
            'companies.rounding_warehouse_decimals',
            'companies.rounding_transactions_enabled',
            'companies.rounding_transactions_decimals',
